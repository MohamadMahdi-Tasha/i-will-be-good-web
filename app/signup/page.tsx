                        ...
                        ? (
                            ...
                            <div className={'min-h-[100vh] max-w-[800px] mx-auto flex justify-center items-center'}>
                                <form onSubmit={(event) => {
                                    ...
                                    const passwordRepeaValue:string = passwordRepeatInputRef.current.value;
                                    ...
                                    <InputComponent refProp={passwordRepeatInputRef} isErrored={false} errorText={''} type={'password'} required id={'password-input'} placeHolder={'Password Repeat:'} />
